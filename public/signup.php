            ...
            <div class="col-lg-5 col-md-7 col-sm-9">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-5 text-center">
                        <div class="mb-4">
                            <a href="../index.php"><img src="../assets/logo/logo_white_bg.png"
                                    alt="AKSyon Medical Center" height="80" class="mb-3"></a>
                            <h5 class="mt-3" style="font-family: 'Times New Roman', serif;">Create Account</h5>
                            <p class="text-muted small">Complete your registration as a
                                <?= ucfirst($user_type) ?>.
                            </p>
                        </div>
                        <?php if (!empty($errors)): ?>
