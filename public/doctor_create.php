            ...
            <div class="col-12 col-md-10 col-lg-8">
                <div class="card shadow-sm rounded-2 my-5">
                    ...
                    <div class="text-center my-2">
                        <a href="../index.php"><img src="../assets/logo/logo_white_bg.png" alt="AKSyon Medical Center"
                                height="100" class="mb-3"></a>
                    </div>
                            ...
                            <div class="mt-3">
                                ...
                                <select class="form-select" name="spec_id" required>
                                    ...
                                    <?php foreach ($specializations as $spec): ?>
                                        <option value="<?= $spec['SPEC_ID'] ?>" <?= ($formData['spec_id'] == $spec['SPEC_ID']) ? 'selected' : '' ?>>
