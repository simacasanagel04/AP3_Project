...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (isset($_POST['update'])) {
        ...
        // Use proper redirect with proper URL construction
        $protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http';
        $host = $_SERVER['HTTP_HOST'];
        $script = str_replace('/modules/doctor-module.php', '', $_SERVER['SCRIPT_NAME']);
        $redirectUrl = $protocol . '://' . $host . $script . '/superadmin_dashboard.php?module=doctor';
...
<?php if ($message): ?>
<div class="alert <?= strpos($message, 'Failed') !== false || strpos($message, 'Error') !== false ? 'alert-danger' : 'alert-success' ?> alert-dismissible fade show">
    <?= $message ?>
