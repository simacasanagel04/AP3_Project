...
<?php if ($message): ?><div class="alert <?= strpos($message, '❌') !== false ? 'alert-danger' : 'alert-info' ?>"><?= htmlspecialchars($message) ?></div><?php endif; ?>
<?php if ($userMessage): ?><div class="alert <?= strpos($userMessage, '⚠️') !== false ? 'alert-warning' : 'alert-success' ?>"><?= $userMessage ?></div><?php endif; ?>
